...
import { getClientLocation } from '../utils/geoUtils'; // IMPORT FUNGSI LOKASI
...
export default function Sidebar({ onLogout, isExpanded, setIsExpanded }) { 
  ...
  // ==========================================
  // PRE-WARMING LOKASI ABAC
  // ==========================================
  // Meminta lokasi secara silent di background saat Sidebar dimuat pertama kali.
  // Ini memastikan cache lokasi sudah terisi sebelum user mengklik menu lain.
  useEffect(() => {
    getClientLocation().catch((err) => {
      console.warn("Pre-warming lokasi dibatalkan/ditolak:", err);
    });
  }, []);
  // ==========================================
