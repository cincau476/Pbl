...
const RoleBadge = ({ role }) => {
  // 1. Normalisasi role agar huruf pertama kapital, sisanya kecil (misal: "admin" -> "Admin")
  ...
  // Gunakan normalizedRole untuk mencocokkan kunci warna
  return (
    <span className={`px-3 py-1 text-[10px] md:text-xs font-bold uppercase rounded-full ${roleColors[normalizedRole] || 'bg-gray-100 text-gray-700'}`}>
      {role}
    </span>
  );
};
